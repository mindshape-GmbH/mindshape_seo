<?php
namespace Mindshape\MindshapeSeo\ViewHelpers\Widget\Controller;
...
class PaginateController extends \TYPO3\CMS\Fluid\ViewHelpers\Widget\Controller\PaginateController
{
    ...
    protected function setViewConfiguration(ViewInterface $view)
    {
        ...
        $settings = GeneralUtility::removeDotsFromTS($typoScript);

        $templateRootPath = $settings['module']['tx_mindshape_seo']['view']['widget'][PaginateViewHelper::class]['templateRootPath'];

        if (
            !empty($templateRootPath) &&
