require([
    ...
    (function ($, Settings, Severity, Modal, MSH) {
        ...
        MSH = {
            ...
            googleDescriptionLongLengthPixel: 1800,
            ...
            init: function () {
                ...
                this.$previewContainers.each(function () {
                    ...
                    if (that.editing) {
                        ...
                        that.updatePreviewEditPanelProgressBar($(this), 'description', that.googleDescriptionLongLengthPixel);
                    } else {
            ...
            registerEvents: function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        if (response.deleted === true) {
                                            ...
                                            console.error('Failed to delete configuration: ' + $deleteButton.attr('data-uid'));
                                        }
                                    },
                                    error: function () {
                                        console.error('Failed to delete configuration: ' + $deleteButton.attr('data-uid'));
                ...
                this.$previewContainers.on('click', '.edit', function (e) {
                    ...
                    if ($currentEditPanel.is(':hidden')) {
                        ...
                        that.updatePreviewEditPanelProgressBar($currentPreview, 'description', that.googleDescriptionLongLengthPixel);
            ...
            updatePreviewEditPanelProgressBar: function ($previewContainer, fieldName, maxLength) {
                ...
                if (fieldLength >= maxLength) {
                    percent = 100;
                    this.isMaxLengthReached = 1000;
                    if (this.googleDescriptionLengthPixel === maxLength) {
                        if ('description' === fieldName) {
                            if (this.isPipeAdded === false) {
                                this.isPipeAdded = true;
                                $previewContainer.find('.edit-panel .description').val('' + fieldText.concat(' | '));
                ...
                if (this.googleDescriptionLongLengthPixel === maxLength) {
                    $previewContainer
                        .find('.edit-panel .progress-longDescription' + ' .progress-bar')
                        .css('width', percent + '%')
